...
public interface CommonConstant {
    ...
    * 知识库第三方系统账号默认初始密码
     */
    public final static String DEFAULT_INIT_PASSWORD = "123456";

    //第三方token，用于api
    public static final String PREFIX_THIRD_USER_TOKEN  = "prefix_third_user_token_";

    public static final String PREFIX_THIRD_USER_ROLEIDS  = "prefix_third_user_local_role_";
