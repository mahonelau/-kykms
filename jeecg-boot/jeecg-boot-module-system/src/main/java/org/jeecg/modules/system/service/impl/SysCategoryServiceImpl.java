...
public class SysCategoryServiceImpl extends ServiceImpl<SysCategoryMapper, SysCategory> implements ISysCategoryService {
	...
	@Override
	@CacheEvict(value = "sys_category",allEntries = true)
	...
	@Override
	// -- 知识库专题
	public List<TreeSelectModel> queryListByCode(String pCode,Boolean recommendFlag) throws JeecgBootException{
...
//			List<SysCategory> list = baseMapper.selectList(new LambdaQueryWrapper<SysCategory>().eq(SysCategory::getCode, pcode));
			...
			List<SysCategory> list = baseMapper.selectList(queryWrapper);
...
//		return baseMapper.queryListByPid(pid,null);
		return baseMapper.queryListByPid(recommendFlag,pid,null);
	}
	...
	public List<TreeSelectModel> queryListByPid(String pid) {
		...
		return baseMapper.queryListByPid(false,pid,null);
	}
	...
	public List<TreeSelectModel> queryListByPid(String pid, Map<String, String> condition) {
		...
		return baseMapper.queryListByPid(false,pid,condition);
	}
	...
	public String queryNameByCode(String code) {
		return baseMapper.queryNameByCode(code);
	}
