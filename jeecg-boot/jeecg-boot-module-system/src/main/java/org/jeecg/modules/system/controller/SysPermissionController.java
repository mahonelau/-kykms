...
//			if(loginUser.getThirdId() != null
//					&& !loginUser.getThirdId().isEmpty()
//					&& loginUser.getThirdType() != null
//					&& !loginUser.getThirdType().isEmpty()) {
//				//根据thirdType和thirdUuid从redis获取第三方平台用户的本地角色
//				List<String> roleIds = (List<String>)redisUtil.get(CommonConstant.PREFIX_THIRD_USER_ROLEIDS + loginUser.getUsername());
//
//				if(roleIds == null || roleIds.size() ==0){
//					result.error500("用户本地角色数据异常");
//					return result;
//				}
//				for (int i = 0; i < roleIds.size() ; i++) {
//
//					List<SysPermission> sysPermissionList = sysPermissionService.queryByRole(roleIds.get(i));
//					if(sysPermissionList != null && sysPermissionList.size() > 0)
//						metaList.addAll(sysPermissionList);
//				}
//			}
//			else{
//				metaList = sysPermissionService.queryByUser(loginUser.getUsername());
