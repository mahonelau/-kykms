    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item
          ...
          required
          label="属性名称">
          <a-input placeholder="请输入属性名称" v-model="model.dictName"/>
        </a-form-model-item>
        ...
        <a-form-model-item
          ...
          required
          label="属性编码">
          <a-input placeholder="请输入属性编码" :disabled="true"  v-model="model.dictCode"/>
        </a-form-model-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        validatorRules: {
          dictName: [{ required: true, message: '请输入属性名称!' }],
          dictCode: [
