...
项目介绍：
-----------------------------------
- 如果您在寻找一款知识库系统，用来将现有的文档资源整理归类，并在团队内共享以充分利用这些文档，或者分享到外部，那么科亿知识库将是您的不二之选。
- 科亿知识库，可以应用在任何需要进行常用文件管理、分类、归集、检索、分享交流的地方，以及需要对大数据进行管理和检索的场景，尤其适合知识密集型单位/历史文档丰富的单位。
  开源版适合个人学习和自用，提供基础功能，可以完整运行；专业版与旗舰版则提供更强大的功能，并提供技术服务，如需要请联系商务。我们的发展策略：以收费的高阶版本维持开源版本。

- 科亿知识库宗旨是: `文件简单整理，分享创造价值`

为什么选择科亿知识库?
-----------------------------------
- 两年多的产品运营历史，历经数十个客户验证，背后是专业的技术团队支撑，让您使用无后顾之忧后。
