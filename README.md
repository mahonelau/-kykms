...
- 支持知识图谱，基于Neo4j构建，通过作者、关键字、标签等关信息进行知识关系可视化。注：知识图谱的功能需基于高阶版本定制。
...
快速部署
-----------------------------------
- 智能版docker镜像 [一键部署](http://docs.kykms.cn/docs/mindoc/docker-singleton)
...
- 智能版在线演示 ： 不再提供在线试用环境，需要体验的可以自行部署docker镜像：[一键部署](http://docs.kykms.cn/docs/mindoc/docker-singleton)
